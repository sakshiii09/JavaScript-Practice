...
//todo Local Storage can only store strings, so when you want to store a complex data
//structure like an array or an object, you need to convert it to a string using JSON.stringify:

//* JSON.stringify: Convert s a JavaScript object into a JSON string.
