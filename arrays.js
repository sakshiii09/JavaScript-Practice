...
// const doubleValue = number.map((curElem1) => {
//   return curElem1 * 2;
...
// let fruit = ["apple", "orange", "mango", "grapes", "banana"];

//? 1: push(): Method that adds one or more elements to the end of an array.
// console.log(fruit.push("guava"));
// console.log(fruit);
...
// fruit.splice(fruit.length, 0, "papaya");
...
// const results = words.map((curElem) => {
